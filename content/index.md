...
- [[flow-structure]] -- Rules for flows: start nodes, lint, deploy cycle, AB's standards
- [[log-tap-behavior]] -- Visibility is level-based, not toConsole/toSideBar. AB confirmed.
...
- [[error-handling]] -- AB's pattern: catch all + catch uncaught -> contextual-end. No contextual-error.
...
- [[no-contextual-error]] -- AB: catch -> end, not contextual-error. Rationale + evidence.
