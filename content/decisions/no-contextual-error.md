...
Andrew's exact words: "contextual-error not in common use. Catch can go to End."
...
Platform training documentation mentions `contextual-error` and implies it should be used for error paths. In practice, the platform team does not use it. Andrew's direction overrides the training docs.
